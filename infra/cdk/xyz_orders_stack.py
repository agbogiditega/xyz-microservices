...
class XyzOrdersStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs):
        ...
        order_events_topic.add_subscription(subs.SqsSubscription(inventory_q))

        # ECR repo for exemplar service image
        repo = ecr.Repository(self, "OrdersRepo", repository_name=f"{name_prefix}-orders")
        ...
        fargate = ecs_patterns.ApplicationLoadBalancedFargateService(
            ...
            task_image_options=ecs_patterns.ApplicationLoadBalancedTaskImageOptions(
                ...
                task_role=task_role,
                log_driver=ecs.LogDriver.aws_logs(stream_prefix="ecs", log_group=log_group),
            ),
